...
const BASE_VAC_REEL_STRIPS = [
    [0,6,2,3,11,4,0,5,6,1,2,6,3,1,7,0,4,6,2,11,1,3,6,8,0,2,4,6,1,3,9,0,6,2,11,4,1,5,6,0,2,3,6,1,7,4,6,0,2,8,1,6,3,4,11,0,6,2,1,5,6,3,4,9,0,6,2,1,7,6,3,4,8,0,6,2,1,3,4,6],
    [1,0,6,4,3,11,1,6,0,5,2,6,1,3,6,7,4,0,6,11,2,1,6,8,3,4,6,0,2,9,1,6,4,3,11,0,6,5,2,1,6,4,3,7,0,6,2,1,8,4,6,3,0,11,1,6,2,5,4,6,3,0,9,1,6,2,4,7,3,6,0,1,8,4,6,2,3,0,1,6],
    [2,1,6,0,4,11,2,6,1,5,0,6,2,4,6,7,3,1,6,11,0,2,6,8,4,3,6,1,0,9,2,6,3,4,11,1,6,5,0,2,6,3,4,7,1,6,0,2,8,3,6,4,1,11,2,6,0,5,3,6,4,1,9,2,6,0,3,7,4,6,1,2,8,3,6,0,4,1,2,6],
    [3,2,6,1,0,11,3,6,2,5,1,6,3,0,6,7,4,2,6,11,1,3,6,8,0,4,6,2,1,9,3,6,4,0,11,2,6,5,1,3,6,4,0,7,2,6,1,3,8,4,6,0,2,11,3,6,1,5,4,6,0,2,9,3,6,1,4,7,0,6,2,3,8,4,6,1,0,2,3,6],
    [4,3,6,2,1,11,4,6,3,5,2,6,4,1,6,7,0,3,6,11,2,4,6,8,1,0,6,3,2,9,4,6,0,1,11,3,6,5,2,4,6,0,1,7,3,6,2,4,8,0,6,1,3,11,4,6,2,5,0,6,1,3,9,4,6,2,0,7,1,6,3,4,8,0,6,2,1,3,4,6]
];

// Free Spins Strips (Symbol 10 / McPepe is heavily injected to trigger collections)
const FS_VAC_REEL_STRIPS = [
    [0,2,6,1,4,10,3,5,0,1,6,2,4,3,0,1,7,6,2,4,3,0,10,1,2,6,4,8,3,0,1,2,4,6,3,0,9,1,2,4,3,6,0,10,1,2,4,5,3,0,6,1,2,4,3,7,0,1,6,2,4,3,10,0,8,1,2,6,4,3,0,1,9,2,6,4,3,0,1,2],
    [1,3,6,2,0,10,4,5,1,2,6,3,0,4,1,2,7,6,3,0,4,1,10,2,3,6,0,8,4,1,2,3,0,6,4,1,9,2,3,0,4,6,1,10,2,3,0,5,4,1,6,2,3,0,4,7,1,2,6,3,0,4,10,1,8,2,3,6,0,4,1,2,9,3,6,0,4,1,2,3],
    [2,4,6,3,1,10,0,5,2,3,6,4,1,0,2,3,7,6,4,1,0,2,10,3,4,6,1,8,0,2,3,4,1,6,0,2,9,3,4,1,0,6,2,10,3,4,1,5,0,2,6,3,4,1,0,7,2,3,6,4,1,0,10,2,8,3,4,6,1,0,2,3,9,4,6,1,0,2,3,4],
    [3,0,6,4,2,10,1,5,3,4,6,0,2,1,3,4,7,6,0,2,1,3,10,4,0,6,2,8,1,3,4,0,2,6,1,3,9,4,0,2,1,6,3,10,4,0,2,5,1,3,6,4,0,2,1,7,3,4,6,0,2,1,10,3,8,4,0,6,2,1,3,4,9,0,6,2,1,3,4,0],
    [4,1,6,0,3,10,2,5,4,0,6,1,3,2,4,0,7,6,1,3,2,4,10,0,1,6,3,8,2,4,0,1,3,6,2,4,9,0,1,3,2,6,4,10,0,1,3,5,2,4,6,0,1,3,2,7,4,0,6,1,3,2,10,4,8,0,1,6,3,2,4,0,9,1,6,3,2,4,0,1]
];
    ...
    for (let c = 0; c < 5; c++) {
        for (let r = 0; r < 3; r++) {
            ...
            f (sym === VACATION_SYMBOLS.LUGGAGE) {
                ...
                let prizeMult;
                if (prizeFloat < 0.45) prizeMult = 2;       // 45% chance
                else if (prizeFloat < 0.75) prizeMult = 5;  // 30% chance
                else if (prizeFloat < 0.90) prizeMult = 10; // 15% chance
                else if (prizeFloat < 0.97) prizeMult = 25; // 7% chance
